...
export default function PhysicianPlayerChat() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Insert message and fetch the inserted row so we can append it immediately
      ...
      // Append the new message locally (realtime subscription will also add it but ensure immediate feedback)
      if (insertedMessage) {
